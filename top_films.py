...
"""
Скрипт выводит топ 10 фильмов, у которых количество рекомендаций не меньше N и количество проголосовавших не меньше M,
где N и M - аргументы командной строки.
"""

def main():
    """функция возвращается топ 10 фильмов"""
    if len(sys.argv) != 3:
